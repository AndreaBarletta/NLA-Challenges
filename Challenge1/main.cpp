...
SparseMatrix<double,RowMajor> convToM(Matrix3d convM, int Aheight, int Awidth)
{
    SparseMatrix<double,RowMajor> m(Aheight * Awidth, Aheight * Awidth);
...
int main(int argc, char **argv)
{
    ...
    Hav2 /= 9.0;
    SparseMatrix<double,RowMajor> A1 = convToM(Hav2, height, width);
    ...
    Hsh2 << 0, -3, 0,
            -1, 9,-3,
            0, -1, 0; 
    SparseMatrix<double,RowMajor> A2 = convToM(Hsh2, height, width);
    ...
    cout << (saveToFile(firstSysSol, height, width, "firstSysSol.png") == 0 ? "Exported first solution as an image" : "Error Occured") << endl;
    ...
    Hlap << 0, -1, 0,
            -1, 4,-1,
            0, -1, 0; 
    SparseMatrix<double,RowMajor> A3 = convToM(Hlap, height, width);
    ...
    //Task 12 (Solve sparse linear system)
    SparseMatrix<double,RowMajor> A = A3;
    ...
    cout << (saveToFile(secSysSol, height, width, "secSysSol.png") == 0 ? "Exported second solution as an image" : "Error Occured") << endl;
